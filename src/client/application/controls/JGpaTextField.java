package client.application.controls;

import java.awt.Color;
import javax.swing.JTextField;
import javax.swing.text.*;

public class JGpaTextField extends JTextField {
    ...
    public JGpaTextField() {

        this(2, DECIMAL);
    }

    public JGpaTextField(int iMaxLen) {
        this(iMaxLen, NUMERIC);
    }

    public JGpaTextField(int iMaxLen, int iFormat) {
